...
DATABASES = {
    'default': {
        ...
        'NAME': '{{ sentry.postgres.database }}',
        'USER': '{{ sentry.postgres.user }}',
        'PASSWORD': '{{ sentry.postgres.password }}',
        'HOST': '{{ sentry.postgres.host }}',
        'PORT': {{ sentry.postgres.port }},
...
SENTRY_URL_PREFIX = '{{sentry.external_url}}'  # No trailing slash!

# If you're using a reverse proxy, you should enable the X-Forwarded-Proto
# and X-Forwarded-Host headers, and uncomment the following settings
{% if sentry.x_forwarded %}
